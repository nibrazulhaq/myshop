...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  final List<Map<String, dynamic>> freshProducts = [
    {'name': 'Tomato', 'image': 'assets/tomato.png', 'price': 5.00, 'description': 'Fresh Tomatoes'},
    {'name': 'Potato', 'image': 'assets/potato.png', 'price': 3.50, 'description': 'Organic Potatoes'},
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () {
              Get.toNamed(MyCartScreen.id); // Navigate to cart screen
            },
          ),
          IconButton(
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.pushNamed(context, TrackOrderScreen.id); // Navigate to Track Order Screen
            },
          ),
        ],
      ),
              ...
              ...[
                ...
                ListTile(
                  ...
                  onTap: () {
                    ...
                    Navigator.pushNamed(context, ContactUsScreen.id); // Navigate to Contact Us
                  },
                ),
                ...
                ListTile(
                  ...
                  onTap: () {
                    Navigator.pop(context);
                    Navigator.pushNamed(context, OrderHistoryScreen.id); // Navigate to order history
                  },
                ),
                ListTile(
                  ...
                  onTap: () {
                    Navigator.pop(context); // Close the drawer
                    Navigator.pushNamed(context, ComboOfferScreen.id); // Navigate to Combo Offers
                  },
                ),
                ...
                ListTile(
                  ...
                  onTap: () {
                    Navigator.pop(context);
                    Navigator.pushNamed(context, TransactionHistoryScreen.id); // Navigate to Transaction History
                  },
                ),
                ...
                ListTile(
                  ...
                  title: Text('Settings'),
                  onTap: () {
                    Navigator.pushNamed(context, SettingsScreen.id); // Navigate to settings screen
                  },
                ),
                    ...
                    Card(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            freshProducts[index]['name']!,
                            style: TextStyle(
                                fontSize: 16, fontWeight: FontWeight.bold),
                            textAlign: TextAlign.center,
                          ),
                          Text(
                            '\$${freshProducts[index]['price'].toStringAsFixed(2)}',
                            style: TextStyle(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                  ...
                                  Get.toNamed('/mycart'); // Ensure that '/mycart' is correctly defined in your routing
                                },
                                child: Text('Add'),
                                style: ElevatedButton.styleFrom(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        backgroundColor: Colors.blue, // Background color for BottomNavigationBar
        items: const [
